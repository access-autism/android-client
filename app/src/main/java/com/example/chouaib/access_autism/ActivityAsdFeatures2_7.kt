...
import kotlinx.android.synthetic.main.activity_asd_features2_7.*

class ActivityAsdFeatures2_7 : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_asd_features2_7)
    }
    ...
    fun onClickNext (v: View){
        if(radioGroup1.checkedRadioButtonId!=-1 && radioGroup2.checkedRadioButtonId!=-1 && radioGroup3.checkedRadioButtonId!=-1 && radioGroup4.checkedRadioButtonId!=-1){
            val intent = Intent(this, ActivityAsdFeatures2_8::class.java)
